var IntroMotion = (function(){
	...
	var self = {
		...
		startInMotion:function(){
			...
			TweenMax.to($(".course-name"), 1.5, {delay:3.5, x:0, autoAlpha:1, ease:Cubic.easeOut});
			TweenMax.to($(".chapter-name"),1, {delay:4, x:0, autoAlpha:1, ease:Cubic.easeOut});
			TweenMax.to($(".page-ending"),0.5, {delay:4.5, y:0, autoAlpha:1, ease:Cubic.easeOut});
		}
	}
