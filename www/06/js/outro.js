var OutroMotion = (function(){
	...
	var self = {
		...
		setInMotion:function(){
			...
			TweenMax.to($(".subject-01"), 0, {y:20, autoAlpha:0});
		...
		startInMotion:function(){
			...
			TweenMax.to($(".subject-01"), 1, {delay:3, y:0, autoAlpha:1, ease:Cubic.easeOut});
			TweenMax.to($(".data-01"), 1, {delay:3.3, y:0, autoAlpha:1, ease:Cubic.easeOut});
			TweenMax.to($(".data-02"), 1, {delay:3.6, y:0, autoAlpha:1, ease:Cubic.easeOut});
			TweenMax.to($(".data-03"), 1, {delay:3.9, y:0, autoAlpha:1, ease:Cubic.easeOut});
			TweenMax.to($(".data-04"), 1, {delay:4.2, y:0, autoAlpha:1, ease:Cubic.easeOut});
			TweenMax.to($(".data-05"), 1, {delay:4.5, y:0, autoAlpha:1, ease:Cubic.easeOut});
