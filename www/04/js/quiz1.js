...
function checkAnswer(quizNum){
	...
	if(quizNum == 0){					// 4지선다
		...
		if(vSelectAnswer2 == ""){
			...
			if(vSelectAnswer2 == 1){
				...
				vQuizResult[quizNum] = 1;
				$("#quiz_feed_"+(quizNum+1)).show();
				$("#q2_n1").removeClass("n-o");
				$("#q2_n1").addClass("n-o-choice");
				$("#q2_correct").show();
				$("#q2_correct1").show();
				$("#btn_2").hide();
	...
	}else if(quizNum == 2){				// 주관식
		vSelectAnswer3 = ($("#q3_n1").val()).toLowerCase().replace(/ /gi, '');
		if(vSelectAnswer3 == ""){
			//vWrongAnswerCnt = 0;
			this.showAlertDiv1();
			playAudio('audio2');
			...
			if(vSelectAnswer3 == "ZERO" || vSelectAnswer3 == "zero" || vSelectAnswer3 == "0" || vSelectAnswer3 == "영" || vSelectAnswer3 == "공"){
				vWrongAnswerCnt = 0;
				vQuizResult[quizNum] = 1;
				$("#quiz_feed_"+(quizNum+1)).show();
				$("#q3_correct").show();
